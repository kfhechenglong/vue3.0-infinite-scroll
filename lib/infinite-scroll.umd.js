...
// CONCATENATED MODULE: ./examples/plugin/uitls.ts
...
// CONCATENATED MODULE: ./examples/plugin/infinite-scroll.ts
...
var infinite_scroll_doBind = function doBind(context) {
  ...
  if (throttleDelayExpr) {
    throttleDelay = Number(self.vm[throttleDelayExpr] || throttleDelayExpr);
  ...
  if (disabledExpr) {
    context.vm.$watch(disabledExpr, function (value) {
      self.disabled = value;
...
//# sourceMappingURL=infinite-scroll.umd.js.map